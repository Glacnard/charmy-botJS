            ...
            MongoClient.connect(url, function (err, db) {
                ...
                dbo.collection(dndRolls).findOne({
                    ...
                    if (majorStatsList.includes(statValue)) {
                        ...
                        message.channel.send(`${statValue} has been increased from ${currentStat} to ${newValue} with a modifier of ${newMod}`);
                    } else {
                        ...
                        message.channel.send(`${statValue} has been increased from ${currentStat} to ${newValue}`);
                    };
                });
               //db.close();
            });
